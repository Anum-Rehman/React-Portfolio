...
const SKILLS = [
  ...
  { type: "React.js", level: 94 },
  { type: "Redux", level: 92 },
  { type: "jQuery", level: 92 },
  { type: "Dialogflow Chatbots", level: 85 },
  { type: "MongoDB", level: 77 },
      ...
      <div className={classes.root}>
        ...
        >
          <div className={classes.drawerHeader}>
            <Avatar alt="Anum Rehman" src={require("../images/profile.jpg")} className={classes.large} />

                    ...
                    <div id="home">
                        <div id="home-overlay">
                            <div className="carousel-caption">
                                ...
                                <FlipInX>
                                    <h5>This is Anum Rehman.I'm very passionate to learn the deeds designing & developing web and mobile apps from scratch while taking into consideration the latest technology trends and techniques.</h5>
                                </FlipInX>
                            </div>
                        </div>
                    </div>
